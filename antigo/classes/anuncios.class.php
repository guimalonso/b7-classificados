...
class Anuncios
{
  ...
  public function getUltimosAnuncios($page, $perPage, $filtros)
  {
    ...
    $sql = $pdo->prepare("SELECT a.*, i.url, c.nome AS categoria FROM anuncios a
  ...
  {
    global $pdo;
    $sql = $pdo->prepare("SELECT a.*, i.url FROM anuncios a
                        LEFT JOIN anuncios_imagens i ON i.id_anuncio = a.id
  ...
  public function getAnuncio($id)
  {
    ...
    $sql = $pdo->prepare("SELECT a.*, c.nome AS categoria, u.telefone FROM anuncios a
